...
// import { updateManifest } from "./manifest/manifest_utilities";
...
//           );
//       }
//     } else if (customerData.status === "Assembly") {
//       switch (page) {
//         case 1:
//           return (
//             <div>
...
//         <Sidebar>
//           {customerData.status === "Pending" ? ( // Brand new manifest
//             <Menu>
...
//               </MenuItem>
//             </Menu>
//           ) : customerData.status === "Assembly" ? ( // Assembly manifest stage
//             <Menu>
//               <MenuItem onClick={() => handleClick(1)} id="sideMenuOption1">
//                 Facility Info
//               </MenuItem>
...
//                 Rooms
//               </MenuItem>
//               <MenuItem onClick={() => handleClick(3)} id="sideMenuOption3">
//                 Equipment
//               </MenuItem>
//               <MenuItem onClick={() => handleClick(4)} id="sideMenuOption4">
//                 Shipping
//               </MenuItem>
//               <MenuItem onClick={() => handleClick(5)} id="sideMenuOption5">
//                 Installation
//               </MenuItem>
//             </Menu>
//           ) : (
//             // Active manifest and facility
//             <Menu>
//               <MenuItem onClick={() => handleClick(1)} id="sideMenuOption1">
//                 Facility Info
//               </MenuItem>
